 ...
 *
 * Phase 4A Delivery 25 — locked default content for the four migration
 * profiles (server / m365 / workspace / tenant). The renderer reads
 * these when both the per-quote override and the org-level default are
 * absent. Reviewed and signed off in design conversation; this file is
 * the canonical source of truth for the words that appear on a
 * Project/Migration appendix when the user hasn't customised anything.
 *
