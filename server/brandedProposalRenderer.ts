...
const TEMPLATE_DEFAULT_PRIMARY = "#1e1b4b";   // deep indigo — chrome
const TEMPLATE_DEFAULT_SECONDARY = "#818cf8"; // violet — accent
const TEMPLATE_DEFAULT_TINT = "#eef2ff";      // pale violet — callout bg
const TEMPLATE_DEFAULT_TINT_ALT = "#f5f3ff";  // pale violet — table zebra
...
function plainLineItemText(text: string | null | undefined): string {
  if (!text) return "";
...
function sumDecimal(values: Array<string | number | null | undefined>): number {
