...
- **Trial** — free, 14 days, 1 user, 10 quotes/month, 100 catalogue items. Lets the user experience the full product before committing.
- **Solo** — £59/month, 1 user, 5 quotes/month, 100 catalogue items. Best for sole traders.
