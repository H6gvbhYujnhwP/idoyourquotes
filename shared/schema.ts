...
export const organizations = pgTable("organizations", {
  ...
  // Generated by server/services/coverImageGeneration.ts after successful
  // brand extraction. The renderer reads cover_image_url and swaps it
  // for a 1-hour signed URL before embedding in print HTML, mirroring
  // the logo-URL pattern. Renderer falls back to flat brand-primary
  // cover if no image is present — generation is purely additive.
