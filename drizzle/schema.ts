...
export type { GeneratedDocument, GeneratedDocuments, BrandedSlotsState, XeroPushRecord } from "../shared/schema";
import type { GeneratedDocuments, BrandedSlotsState, XeroPushRecord } from "../shared/schema";
...
export const quotes = pgTable("quotes", {
   ...
   *  Null = never pushed. See XeroPushRecord in shared/schema.ts. */
