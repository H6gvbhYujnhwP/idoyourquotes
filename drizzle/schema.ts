...
export const organizations = pgTable("organizations", {
  ...
  // Phase 4A — Cover hero imagery (migration 0018_add_cover_imagery,
  // Delivery 12). Generated by server/services/coverImageGeneration.ts
  // chained from brandExtraction.ts on success. Reused across every
  // proposal that org sends until brand evidence changes. Renderer
  // falls through to flat-colour cover when null.
  coverImageUrl: text("cover_image_url"),
  coverImageStatus: varchar("cover_image_status", { length: 20 }).default("idle"),
